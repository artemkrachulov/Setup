...
public final class ConfigLoader {
	 ...
	 */
    public static func parseFile<C: Decodable>(named fileName: String = ConfigName) -> C {
		...
		do {
			let config = try PropertyListDecoder().decode(C.self, from: fileData)
			return config
		} catch {
...
//    public static func parseFile<C: Decodable>(named fileName: String = ConfigName) -> Configuration {
//
//    }
}
